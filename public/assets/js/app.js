...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const carouselData = [
    {
        ...
        imagem: "/public/assets/img/Banners/Banner_Deepwoken1.jpg",
        link: "/public/detalhe.html?id=guia"
    },
    {
        titulo: "Etris",
        descricao: "Um Reino próspero e em constante evolução",
        imagem: "/public/assets/img/Banners/Banner_Deepwoken2.png",
        link: "/public/detalhe.html?id=etris"
    },
    {
        titulo: "The Deepths",
        descricao: "O Submundo do jogo, MORTE PERMANENTE!",
        imagem: "/public/assets/img/Banners/Banner_Deepwoken3.png",
        link: "/public/detalhe.html?id=deepths"
    }
    ];
    ...
    const dados = [
        ...
        //Armas
        {
            ...
            imagem: "/public/assets/img/Cards/Armas_Card.jpg"
        },
        //Etris
        {
            id: "etris",
            ...
            imagem: "/public/assets/img/Cards/Etris_card.jpg"
        },
        //Deepths
        {
            id: "deepths",
            ...
            imagem: "/public/assets/img/Cards/Deepths_Card.jpg"
        },
        //Bells
        {
            id: "bells",
            ...
            imagem: "/public/assets/img/Cards/Bells_Card.jpg"
        },
        //Oaths
        {
            id: "oaths",
            ...
            imagem: "/public/assets/img/Cards/Oaths_Card.jpg"
        },
        //Mobs
        {
            id: "mobs",
            ...
            imagem: "/public/assets/img/Cards/Monsters_Card.jpg"
        },
        //Bosses
        {
            id: "bosses",
            ...
            imagem: "/public/assets/img/Cards/Boses_Card.jpg"
        },
        //Layer 2
        {
            id: "layer2",
            ...
            imagem: "/public/assets/img/Cards/Layer2_Card.jpg"
        }
    ]; 
    ...
    dados.forEach(item => {
        ...
        card.innerHTML = `
            ...
            <div class="card-body">
                ...
                <a href="/public/detalhe.html?id=${item.id}" class="btn btn-primary">Detalhes</a>
            </div>
        `;
